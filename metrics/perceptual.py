...
class L1PerceptualLoss(nn.Module):
    def __init__(self, lambda_L1, lambda_perceptual, 
                 perceptual_layers, gpu_ids=[0], 
                 percep_is_l1=True, verbose=False):
        super().__init__()
        ...
        self.multi_gpu = True if len(self.gpu_ids) > 1 else False
        ...
        if self.verbose: print(self.vgg_submodel)
