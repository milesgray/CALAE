...
class RCAN_PA(nn.Module):
    ''' RCAN + PA '''
    
    def __init__(self, n_resgroups=10, n_resblocks=20, n_feats=64, res_scale=1, n_colors=3, rgb_range=1, scale=4, reduction=16, conv=arch_util.default_conv):
