...
class AngularTripletCenterLoss(nn.Module):
    def __init__(self, margin=0.5, eps=1e-7, spkr_num=20, utt_num=10):
        """Pytorch implementation of Angular Triplet Center Loss.
            https://arxiv.org/abs/1811.08622
            Angular Triplet-Center Loss for Multi-view 3D Shape Retrieval

        Args:
            margin (float, optional): [description]. Defaults to 0.5.
            eps ([type], optional): [description]. Defaults to 1e-7.
            spkr_num (int, optional): [description]. Defaults to 20.
            utt_num (int, optional): [description]. Defaults to 10.
        """
